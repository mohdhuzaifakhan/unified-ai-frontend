    ...
    const navGroups = [
        {
            title: "Core Services",
            items: [
                { icon: LayoutDashboard, label: "Overview", path: "/agents" },
                { icon: Activity, label: "Live Monitoring", path: "/agents/monitoring" },
                { icon: Layers, label: "Workflow Builder", path: "/agents/workflow-builder" },
            ],
        },
        {
            title: "Optimization",
            items: [
                { icon: BarChart2, label: "Performance Eval", path: "/agents/evaluation" },
                { icon: Settings, label: "Model Calibration", path: "/agents/calibration" },
            ],
        },
        {
            title: "Navigation",
            items: [
                { icon: ArrowLeft, label: "Return to RAG", path: "/rag" },
            ],
        },
    ];
