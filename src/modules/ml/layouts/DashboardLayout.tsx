...
import { LayoutDashboard, FolderKanban, Database, Box, Settings, Bell, Search, Shield, Cpu, CreditCard, Rocket, Wrench, BarChart2, PlusCircle, LogOut, Zap } from "lucide-react";
        ...
        <div className="min-h-screen bg-background text-slate-100 flex font-sans">
            <aside className="w-64 border-r border-glass-border bg-glass-surface/30 backdrop-blur-xl flex flex-col fixed h-full z-20">
                <div className="h-16 flex items-center px-6 border-b border-glass-border shrink-0">
                    <Link to="/" className="text-xl font-bold font-display tracking-tight text-white flex items-center gap-2 hover:opacity-80 transition-opacity">
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto scrollbar-hide select-none">
                    {NAV_ITEMS.map((item) => {
                ...
                <div className="p-4 border-t border-glass-border space-y-2 shrink-0 bg-background/50 backdrop-blur-md">
